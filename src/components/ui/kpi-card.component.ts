...
@Component({
  ...
  template: `
    <article class="h-full rounded-2xl border shadow-lg p-4 flex flex-col gap-3 transition-all hover:shadow-xl relative overflow-hidden group"
...
export class KpiCardComponent {
  ...
  containerClasses = computed(() => {
    const base = "bg-white dark:bg-slate-900/60 border-slate-200 dark:border-slate-700/60";
    return base;
  });
